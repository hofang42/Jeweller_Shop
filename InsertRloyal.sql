...
('tuankhai', '0905536131', 'tuankhai2608@gmail.com', 'na290604', 'Hoang Phuc Tran Van', 0, 1),
('khanh1', '0905536131', 'duykhanhpham2004@gmail.com', 'na290604', 'Hoang Phuc Tran Van', 0, 1)
...
create table tokenForgetPassword(
	...
	isUsed bit not null,
	userId int not null,
	FOREIGN KEY (userId) references [user_web](user_id)
	);
